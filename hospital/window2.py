...
def menu():
    ...
    button4 = tkinter.Button(root1, text="2.BOOK APPOINTMENT",bg='light green',fg='black',command=appo)
    button5 = tkinter.Button(root1, text="3.PATIENT BILL",bg='light blue',fg='black',command=BILLING)
...
def PAT():
    ...
    sex=tkinter.Label(rootp,text="Gender")
